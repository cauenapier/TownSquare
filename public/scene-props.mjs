 ...
 *
 * Site-specific scenes are derived from public/site-config.mjs. This module keeps
 * the default TownSquare shape as a simple exported constant for callers that do
 * not provide a per-site override.
 */
